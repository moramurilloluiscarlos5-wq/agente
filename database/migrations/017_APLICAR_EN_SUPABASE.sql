-- ═══════════════════════════════════════════════════════════════════════
--  APLICAR EN SUPABASE → SQL EDITOR (proyecto nnoqmiwarxrlmtokqxub)
--  Origen: database/migrations/016 (drop) + 017_workshop_onboarding.sql
--  Efecto: /registrar crea cuenta + taller + rol OWNER en un solo paso.
--  Es seguro: no borra datos, solo reemplaza las funciones.
-- ═══════════════════════════════════════════════════════════════════════
drop function if exists public.provision_workshop(uuid, text, text, text, text, text);
